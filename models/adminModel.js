...
const AdminsubcategoryFreelancerSchema = new mongoose.Schema({
 category_id: { type: mongoose.Schema.Types.ObjectId, ref:"freelancer_categories", required: true },
...
const Adminmarketplaceskilleds = new mongoose.Schema({
   ...
   const AdminmarkettoolsEquipment = new mongoose.Schema({
	marketcateid: { type: mongoose.Schema.Types.ObjectId, ref: "market_categories", required: true },
	title: { type: String, required: true },
	description: { type: String },
...
const AdminsubcategorymainPowerSchema = new mongoose.Schema({
        power_category_id: { type: mongoose.Schema.Types.ObjectId, ref:"main_power_categories", required: true },
	sub_cate_name: { type: String, required: true },
...
const FreelancerCategory = mongoose.model("freelancer_categories", AdmincategoryFreelancerSchema);
const FreelancerSubCategory = mongoose.model("freelancer_subcategories",AdminsubcategoryFreelancerSchema);
...
const freelancerbanner = mongoose.model("freelancer_banners",AdminFreelancerbannerAdd);
const marketcate = mongoose.model("market_categories",AdminmarketcategoryjobSchema);
const servicecate = mongoose.model("service_categories",AdminservicecategoryjobSchema);
const market_banner = mongoose.model("market_place_banners",AdminmarketplacebannerAdd);
const market_skilled = mongoose.model("market_place_skilled",Adminmarketplaceskilleds);
const market_tools = mongoose.model("market_tools_equipments",AdminmarkettoolsEquipment);
...
const BussinessBanner = mongoose.model("business_banners",AdminBusinessbannerAdd);
const CompanyBanner = mongoose.model("company_banners",AdminCompanybannerAdd);
const IndividualBanner = mongoose.model("individual_banners",AdminIndividualbannerAdd);
const Power_Cat = mongoose.model("main_power_categories",AdminmainpowercategorySchema);
const Power_Cat_Sub = mongoose.model("main_power_sub_categories",AdminsubcategorymainPowerSchema);
const FreelancerHeadline = mongoose.model("freelancer_headline",FreelancerHeadLineSchema);
const BusinessHeadline = mongoose.model("business_headline",BusinessHeadLineSchema);
const CompanyHeadline = mongoose.model("company_headline",CompanyHeadLineSchema);
const IndividualHeadline = mongoose.model("individual_headline",IndividualHeadLineSchema);
const FreelancerBenefit = mongoose.model("freelancer_benefit",FreelancerBenefitSchema);
const BusinessBenefit = mongoose.model("business_benefit",BusinessBenefitSchema);
const CompanyBenefit = mongoose.model("company_benefit",CompanyBenefitSchema);
const IndividualBenefit = mongoose.model("individual_benefit",IndividualBenefitSchema);
